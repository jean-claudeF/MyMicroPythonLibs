...
class SD():
    def __init__(self, spibus, SD_CS, sdfolder = "/SD"):
        print("Defining SD")
        self.spibus = spibus
        self.SD_CS = SD_CS
        ...
        # define SD
        try:
            self.sd = sdcard.SDCard(spibus, Pin(SD_CS))
...
if __name__ == "__main__":
    ...
    spibus = SPI(0, sck=Pin(6), mosi=Pin(7), miso=Pin(4))      # the numbers mean GPIO pin numbers e.g. 4 = GPIO4
    
    sd = SD(spibus, SD_CS)         # or:   sd = SD(spibus, SD_CS, sdfolder)     
